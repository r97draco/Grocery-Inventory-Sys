/**
 * It checks if the input is valid, if it is, it will submit the form, if not, it will prevent the form
 * from submitting and display error messages
 * @param event - The event object is a JavaScript object that contains information about the current
 * event.
 */
...
/* A regular expression that checks if the input is valid. */
...
/* Getting the element from the html file and setting the innerHTML to empty. */
...
/* Checking if the form is valid, if it is, it will submit the form, if not, it will prevent the form
from submitting and display error messages. */
    if (valid == true) {
...
/**
 * It resets the form and clears all the error messages.
