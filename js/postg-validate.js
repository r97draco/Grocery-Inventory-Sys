/**
 * The function checks if the title, description and quantity are empty or not. If they are empty, it
 * will display an error message. If they are not empty, it will submit the form
...
function PostForm(event) {
  ...
  if (qty == null || title == "" || qty < 1) {
    textNode = document.createTextNode(
      "Quantity can not be Empty or less than 1."
    );
