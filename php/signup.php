...
if (isset($_POST["submitted"]) && $_POST["submitted"])
{
    ...
    /* This is connecting to the database and checking if the email is already in the database. */ 
    ...
    if($validate == true)
    {
       ...
       /* This is inserting the user into the database. */
...
/* This is displaying an error message if the email is already in the database. */
    else
    {
