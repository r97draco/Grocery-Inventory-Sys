<!-- /* This is the code for the postg.php file. It is the page where the user can post groceries. */ -->
<?php
/* This is the code that is used to validate the form. */
$validate = true;
$title ="";
$desc ="";
$qty =0;
...
if (isset($_POST["submitted"]) && $_POST["submitted"])
{
    ...
    if($validate == true)
    {
      /* This is the code that is used to insert the data into the database. */
      session_start();
      $uid =$_SESSION['u_id'];
      $fid =$_SESSION['f_id'];
    ...
    /* This is the code that is used to display an error message if the user does not enter the correct
information. */
    else
    {
  ...
  <body>
    ...
    <nav class="left">
      <ul>
        ...
        <!-- /* This is a php code that is used to display the username of the user that is logged in. */ -->
        <?php
        session_start();
        ...
        <li style="float:right"><a href="#">
        <!-- /* This is a php code that is used to display the family name of the user that is logged in. */ -->
        <?php
        session_start();
...
<!-- /* This is the form that the user will use to post groceries. */ -->
    <section>
