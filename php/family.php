<!-- /* This is the php code for the family page. It is checking if the form has been submitted and if the family name has been entered. */ -->
<?php
session_start();
$validate = false;
$fnameSel = "";
...
/* This is checking if the form has been submitted and if the family name has been entered. */
...
/* This is connecting to the database. */
  ...
  if($validate == true)
  {
        /* This is inserting the family name into the family table. */
       ...
       $r2 = $db->query($q2);
        ...
        if ($r2 === true)
        {
            /* This is updating the user table with the family id. */
    ...
    {
/* This is displaying error message if family could not be added. */
...
/* This is the php code for the family page. It is checking if the form has been submitted and if
    the
    family name has been entered. */

/* Selecting the family id from the family table. */
    ...
    if($validate == true)
    {
       ...
       $r2 = $db->query($q2);
        ...
        /* This is checking if the family name has been entered. */
        if ($r2 === true)
        {
            $_SESSION["f_id"]=$row1['f_id'];
...
<!-- /* This is the html code for the family page. It is displaying the family page. */ -->
<!DOCTYPE html>
<html>
...
<body>
  ...
  <!-- /* This is the navigation bar for the family page. It is displaying the navigation bar. */ -->
  <nav class="left">
    <ul>
...
<!-- /* This is the section of the family page. It is displaying the family page. */ -->
  <section>
    <table>
      <tr>
        <td>
